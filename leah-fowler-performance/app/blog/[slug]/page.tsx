...
const components = {
  h1: (props: unknown) => <h1 className="text-4xl font-bold text-gray-900 mt-8 mb-4" {...props} />,
  h2: (props: unknown) => <h2 className="text-3xl font-bold text-gray-900 mt-8 mb-4" {...props} />,
  h3: (props: unknown) => <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3" {...props} />,
  p: (props: unknown) => <p className="text-lg text-gray-700 mb-6 leading-relaxed" {...props} />,
  ul: (props: unknown) => <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2" {...props} />,
  ol: (props: unknown) => <ol className="list-decimal list-inside text-gray-700 mb-6 space-y-2" {...props} />,
  li: (props: unknown) => <li className="text-lg leading-relaxed" {...props} />,
  ...
  img: (props: unknown) => (
    <img className="w-full rounded-lg my-6" {...props} />
  ),
  table: (props: unknown) => (
...
async function getPost(slug: string): Promise<Post | null> {
  ...
  const formattedPost = {
    ...data,
    tags: data.tags?.map((t: unknown) => t.tag).filter(Boolean) || []
  }
