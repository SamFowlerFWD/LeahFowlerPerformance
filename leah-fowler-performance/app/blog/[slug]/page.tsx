...
const components = {
  h1: (props: any) => <h1 className="text-4xl font-bold text-gray-900 mt-8 mb-4" {...props} />,
  h2: (props: any) => <h2 className="text-3xl font-bold text-gray-900 mt-8 mb-4" {...props} />,
  h3: (props: any) => <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3" {...props} />,
  p: (props: any) => <p className="text-lg text-gray-700 mb-6 leading-relaxed" {...props} />,
  ul: (props: any) => <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2" {...props} />,
  ol: (props: any) => <ol className="list-decimal list-inside text-gray-700 mb-6 space-y-2" {...props} />,
